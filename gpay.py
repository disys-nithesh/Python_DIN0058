...
nithesh=gp.Google_pay("nithesh7776@gmail.com","9001111111","Nithesh N")
nithesh.open_gpay()
nithesh.email_verification()
nithesh.mobile_verification()
nithesh.name_verification()
nithesh.otp_verification(15698,15698)
nithesh.Bank_verification()
nithesh.PanCard_Verification()
nithesh.set_Pin("5384")
nithesh.Enter_your_Pin(3465,3465)
...
bolt=Phone_pe("nithesh7777@gmail.com","9000000000","nithesh")
bolt.open_phonepe()
bolt.mobile_verification()
bolt.name_verification()
bolt.otp_verification(780965,780965)
bolt.Bank_verification()
bolt.PanCard_Verification()
bolt.set_Pin("238790")
bolt.Enter_your_Pin(3564,3564)


        
googlepay=[{"name":"nithesh","gpaynum":7397266887,"type":"personal","transaction":"regular"},                       
